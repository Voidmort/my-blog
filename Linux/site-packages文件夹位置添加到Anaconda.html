<!DOCTYPE html>
<html lang="zh" dir="ltr"><head><title>site-packages文件夹位置添加到Anaconda</title><meta charset="utf-8"/><link rel="preconnect" href="https://fonts.googleapis.com"/><link rel="preconnect" href="https://fonts.gstatic.com"/><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Schibsted Grotesk:wght@400;700&amp;family=Source Sans Pro:ital,wght@0,400;0,600;1,400;1,600&amp;family=IBM Plex Mono:wght@400;600&amp;display=swap"/><link rel="preconnect" href="https://cdnjs.cloudflare.com" crossorigin="anonymous"/><meta name="viewport" content="width=device-width, initial-scale=1.0"/><meta name="og:site_name" content="我的博客"/><meta property="og:title" content="site-packages文件夹位置添加到Anaconda"/><meta property="og:type" content="website"/><meta name="twitter:card" content="summary_large_image"/><meta name="twitter:title" content="site-packages文件夹位置添加到Anaconda"/><meta name="twitter:description" content="要将新的site-packages文件夹位置添加到Anaconda Python中，可以按照以下步骤操作： 打开你的终端或命令提示符（Windows）。 输入conda info --envs以查看当前存在的环境及其安装路径。 选择您想要添加新site-packages的环境并激活它。例如，使用以下命令激活名为myenv的环境： 复制代码 conda activate myenv 在激活的环境中，输入以下命令，其中”path/to/new/site-packages”是您要添加的新目录的路径： 复制代码 conda develop path/to/new/site-packages 确认是否成..."/><meta property="og:description" content="要将新的site-packages文件夹位置添加到Anaconda Python中，可以按照以下步骤操作： 打开你的终端或命令提示符（Windows）。 输入conda info --envs以查看当前存在的环境及其安装路径。 选择您想要添加新site-packages的环境并激活它。例如，使用以下命令激活名为myenv的环境： 复制代码 conda activate myenv 在激活的环境中，输入以下命令，其中”path/to/new/site-packages”是您要添加的新目录的路径： 复制代码 conda develop path/to/new/site-packages 确认是否成..."/><meta property="og:image:alt" content="要将新的site-packages文件夹位置添加到Anaconda Python中，可以按照以下步骤操作： 打开你的终端或命令提示符（Windows）。 输入conda info --envs以查看当前存在的环境及其安装路径。 选择您想要添加新site-packages的环境并激活它。例如，使用以下命令激活名为myenv的环境： 复制代码 conda activate myenv 在激活的环境中，输入以下命令，其中”path/to/new/site-packages”是您要添加的新目录的路径： 复制代码 conda develop path/to/new/site-packages 确认是否成..."/><meta property="twitter:domain" content="blog.38324.cn"/><meta property="og:url" content="https://blog.38324.cn/Linux/site-packages文件夹位置添加到Anaconda"/><meta property="twitter:url" content="https://blog.38324.cn/Linux/site-packages文件夹位置添加到Anaconda"/><link rel="icon" href="../static/icon.png"/><meta name="description" content="要将新的site-packages文件夹位置添加到Anaconda Python中，可以按照以下步骤操作： 打开你的终端或命令提示符（Windows）。 输入conda info --envs以查看当前存在的环境及其安装路径。 选择您想要添加新site-packages的环境并激活它。例如，使用以下命令激活名为myenv的环境： 复制代码 conda activate myenv 在激活的环境中，输入以下命令，其中”path/to/new/site-packages”是您要添加的新目录的路径： 复制代码 conda develop path/to/new/site-packages 确认是否成..."/><meta name="generator" content="Quartz"/><link href="../index.css" rel="stylesheet" type="text/css" spa-preserve/><style>.expand-button {
  position: absolute;
  display: flex;
  float: right;
  padding: 0.4rem;
...
<p>注意：以上命令假设您已经安装了conda，并且已经在系统PATH中设置了conda。如果没有，请确保先安装conda并将其添加到PATH中，然后再尝试上述步骤。</p></article><hr/><div class="page-footer"></div></div><div class="right sidebar"><div class="graph"><h3>关系图谱</h3><div class="graph-outer"><div class="graph-container" data-cfg="{&quot;drag&quot;:true,&quot;zoom&quot;:true,&quot;depth&quot;:1,&quot;scale&quot;:1.1,&quot;repelForce&quot;:0.5,&quot;centerForce&quot;:0.3,&quot;linkDistance&quot;:30,&quot;fontSize&quot;:0.6,&quot;opacityScale&quot;:1,&quot;showTags&quot;:true,&quot;removeTags&quot;:[],&quot;focusOnHover&quot;:false,&quot;enableRadial&quot;:false}"></div><button class="global-graph-icon" aria-label="Global Graph"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 55 55" fill="currentColor" xml:space="preserve"><path d="M49,0c-3.309,0-6,2.691-6,6c0,1.035,0.263,2.009,0.726,2.86l-9.829,9.829C32.542,17.634,30.846,17,29,17
                ...
                s-2-0.897-2-2s0.897-2,2-2S47,39.897,47,41z M49,10c-2.206,0-4-1.794-4-4s1.794-4,4-4s4,1.794,4,4S51.206,10,49,10z"></path></svg></button></div><div class="global-graph-outer"><div class="global-graph-container" data-cfg="{&quot;drag&quot;:true,&quot;zoom&quot;:true,&quot;depth&quot;:-1,&quot;scale&quot;:0.9,&quot;repelForce&quot;:0.5,&quot;centerForce&quot;:0.2,&quot;linkDistance&quot;:30,&quot;fontSize&quot;:0.6,&quot;opacityScale&quot;:1,&quot;showTags&quot;:true,&quot;removeTags&quot;:[],&quot;focusOnHover&quot;:true,&quot;enableRadial&quot;:true}"></div></div></div></div><footer class><p></p><ul><li><a href="https://github.com/Voidmort">GitHub</a></li></ul></footer></div></div></body><script type="application/javascript">function n(){let t=this.parentElement;t.classList.toggle("is-collapsed");let e=t.getElementsByClassName("callout-content")[0];if(!e)return;let l=t.classList.contains("is-collapsed");e.style.gridTemplateRows=l?"0fr":"1fr"}function c(){let t=document.getElementsByClassName("callout is-collapsible");for(let e of t){let l=e.getElementsByClassName("callout-title")[0],s=e.getElementsByClassName("callout-content")[0];if(!l||!s)continue;l.addEventListener("click",n),window.addCleanup(()=>l.removeEventListener("click",n));let o=e.classList.contains("is-collapsed");s.style.gridTemplateRows=o?"0fr":"1fr"}}document.addEventListener("nav",c);
